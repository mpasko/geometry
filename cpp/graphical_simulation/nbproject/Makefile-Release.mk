...
${OBJECTDIR}/Figures_factory.o: Figures_factory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Figures_factory.o Figures_factory.cpp

${OBJECTDIR}/GSegment.o: GSegment.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GSegment.o GSegment.cpp

${OBJECTDIR}/Display_properties.o: Display_properties.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Display_properties.o Display_properties.cpp

${OBJECTDIR}/GFigure.o: GFigure.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GFigure.o GFigure.cpp

${OBJECTDIR}/OutputManager.o: OutputManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/OutputManager.o OutputManager.cpp

${OBJECTDIR}/GPoint.o: GPoint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GPoint.o GPoint.cpp

${OBJECTDIR}/GPolygon.o: GPolygon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GPolygon.o GPolygon.cpp
